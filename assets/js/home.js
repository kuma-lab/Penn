...
function initSlick(category) {
    ...
    *****************************************************/
    ...
    $('.newsfeed.' + category + ' .slickContainer').on('afterChange', function (event, slick, currentSlide) {
        ...
        localStorage.setItem('slide' + capitalizeFirstLetter(category), currentSlide)
    });

    // If currentSlide of category saved, go to the right slide
    if (localStorage.getItem('slide' + capitalizeFirstLetter(category))) $('.newsfeed.' + category + ' .slickContainer').slick('slickGoTo', localStorage.getItem('slide' + capitalizeFirstLetter(category)))
...
$(document).ready(function () {
    ...
    if (localStorage.getItem('feed')) {
        switch (localStorage.getItem('feed')) {
            case 'all':
...
for (let choice of choices) {
    choice.addEventListener('click', function (e) {
        ...
        // Save category feed on localStorage
        localStorage.setItem('feed', category);
    })
}
